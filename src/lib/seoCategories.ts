...
export const SEO_CATEGORIES: SeoCategory[] = [
  {
    ...
    introduction: [
      ...
      "قبل استكمال التنفيذ، بنجهز تصميم شخصية متكامل (Character Sheet) للطفل وبنرسل عينة لولي الأمر للاعتماد، عشان ملامح البطل تفضل ثابتة عبر مشاهد القصة. والطلب ممكن يشمل إهداء باسم المرسل وتوصيل مباشر لمستلم الهدية داخل مصر.",
    ],
    highlights: [
