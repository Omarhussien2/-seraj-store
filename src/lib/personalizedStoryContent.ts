...
export const personalizedStorySteps = [
  ...
  {
    title: "نصمم شخصيته",
    body: "نجهز تصميم شخصية متكامل (Character Sheet) للطفل، يساعدنا نحافظ على اتساق شكل البطل وملامحه عبر مشاهد الحكاية.",
  },
  {
    title: "راجع العينة",
...
export const personalizedStoryProductCopy = {
  name: "قصة مخصصة بطلها طفلك",
  shortDescription: "قصة كاملة بتتكتب لطفلك من البداية",
  longDescription:
...
export const personalizedStorySiteContent = [
  ...
  {
    key: "hero.cta_products",
    section: "hero",
    value: "استكشف عالم سراج",
  },
  {
    key: "showcase.custom_story.title",
    section: "showcase",
    value: "🌟 قصة مخصوصة.. بطلها طفلك نفسه!",
  },
  {
    key: "showcase.custom_story.desc",
    section: "showcase",
    value:
      "عايز تفاجئ طفلك بهدية عمره ما هينساها؟ احكيلنا عن طفلك والقيمة اللي تهمك — شجاعة، ثقة، صبر، أو موقف خاص — وارفع صوره. نجهز له تصميم شخصية متكامل (Character Sheet) يساعدنا نحافظ على اتساق شكل البطل، ونرسل لك عينة لاعتمادها قبل استكمال القصة. بعدها نحولها لحكاية مطبوعة بطلها هو، بإهداء لو حبيت وتوصيل لعنوانك أو مباشرةً لمستلم الهدية داخل مصر.",
  },
] as const;
