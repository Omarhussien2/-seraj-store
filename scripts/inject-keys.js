...
const data = [
  ...
  { key: "counter.subtext", val: "صور حقيقية من أمهات وثقوا في سِراج عشان يرسموا الفرحة على وشوش أطفالهم." },
  
  { key: "how.kicker", val: "٣ خطوات بس" },
  { key: "how.heading", val: "إزاي سراج بيعمل قصة بصورة ابنك؟" },
  { key: "how.step1_title", val: "قولي لسراج اسم بطلنا وسنه" },
  { key: "how.step1_desc", val: "اكتبي بياناته واختاري القيمة الأخلاقية اللي محتاج يتعلمها." },
  { key: "how.step2_title", val: "ارفعي أحلى صورة ليه" },
  { key: "how.step2_desc", val: "سراج هياخد الصورة ويخلي ابنك هو البطل الحقيقي للقصة." },
  { key: "how.step3_title", val: "استلمي قصتك لحد البيت" },
  { key: "how.step3_desc", val: "هتستلمي قصة مطبوعة بألوان مبهجة وتغليف يفرّح القلب." },
  
  { key: "values.kicker", val: "القيم اللي هيتعلمها" },
  { key: "values.heading", val: "اختاري القيمة اللي بطلنا محتاجها النهاردة" },
  
  { key: "testimonials.kicker", val: "كلام أمهاتنا" },
  { key: "testimonials.heading", val: "اللي قالتوه عن سِراج" },
  
  { key: "ribbon.heading", val: "مستنية إيه؟ خلّي بطلنا يبدأ حكايته النهاردة!" },
  ...
  { key: "mama.hero_title", val: "أهلاً بِكِ في عالم ماما" },
  { key: "mama.hero_desc", val: "مساحة من القلب للأم.. مقالات، نصايح، وأماكن تحبيها لبطلنا الصغير ✦" }
];
