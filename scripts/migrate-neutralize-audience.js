...
const CONTENT_UPDATES = [
  ...
  { key: 'how.step3_desc', val: 'القصة بتتطبع بجودة عالية وتوصلك لحد باب البيت.' },
...
const PRODUCT_UPDATES = {
  ...
  'custom-story': {
    ...
    ctaText: 'ابدأ القصة',
    longDesc:
      'هل تخيلت يوماً فرحة طفلك وهو يرى نفسه بطلاً في كتاب حقيقي؟ في "سراج"، بنقدم تجربة قراءة تفاعلية ومختلفة. بنصمم قصة مخصصة لطفلك، اسمه موجود في كل صفحة مع شخصية تقرب من ملامحه، عشان يعيش القصة بنفسه ويتحول البطل اللي بيتعلم منه. القصص مبنية بذكاء عشان تغرس قيم يومية مهمة من غير توجيه مباشر أو كلام إنشائي، هدية ستعيش معه وتزرع فيه حب القراءة منذ الصغر.',
    features: [
      'اسم طفلك وملامحه جوه القصة',
      'قيم بذكاء وبدون توجيه',
      'بديل ذكي للشاشات',
      'خامات عملية تعيش',
      'هدية جاهزة وقيمة',
    ],
