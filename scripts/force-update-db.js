...
const updates = [
  ...
  { key: "counter.subtext", val: "صور حقيقية من عائلات جربت سِراج وبعتت لنا كتب بطلهم في إيديه" },
  { key: "how.step1_desc", val: "ادخل اسم طفلك وسنّه، واختار القيمة اللي عايزه يتعلمها.. وسراج هيبدأ الشغل." },
  { key: "how.step2_title", val: "سراج هيدخل ورشه السحرية يكتب ويرسم القصة مخصوص ليه" },
  { key: "how.step2_desc", val: "في الورشة، سراج بيكتب القصة باسم بطلك ويرسمها برسومات أصلية مبهجة.. كل حاجة مخصوصة." },
