...
└── assets/             — صور الشخصيات (9 شخصيات)
    ...
    ├── mom-amira.png           — تقى الأم (حجاب أحمر + مخططات + بوصلة ✓ الصحيحة)
    ├── dad-mostafa.png         — عمر الأب (ثوب + حزام أدوات + مخطوطة)
...
|---|---|---|---|
| سِراج ★ | `seraj.png` | أرنب أخضر | البطل الرئيسي — في كل الصفحات |
| الجدة زينب | `grandma-fatima-seated.png` | جالسة على عثماني، نقاب أخضر، عقد تروس | حارسة الحكايات |
| تقى (الأم) | `mom-amira.png` | حجاب أحمر، مخططات + بوصلة | مخترعة آلة الزمن |
| عمر (الأب) | `dad-mostafa.png` | ثوب بيج، حزام أدوات، مخطوطة | المؤرخ المستكشف |
| القائد خالد | `khaled-v2.png` | درع نحاسي، عمامة، سيف مقوّس | بطل الشجاعة (Step 2 في الـ Wizard) |
| هدى | `huda-bird.png` | حمامة نحاسية آلية | رفع الصورة (Step 3 في الـ Wizard) + رفاق المغامرات |
| ليلى | `layla.png` | كتاب "قصص وحكايات"، ترس ذهبي | رفيقة الرحلة الوفيّة |
| يونس | `omar.png` | نظارة مكبّرة، حقيبة تروس | رفيق المغامرات |
| داوود الصغير | `zain.png` | قبعة طيار، يحمل هدى | أخو يونس |
